...
def main():
# python main.py --image_size 32 --in_channels 3 --num_channels 64
# --context_channels 256 --dropout 0.2 --num_res_blocks 2 --model vfsddpm
# --learn_sigma True --diffusion_steps 1000 --noise_schedule linear --lr 1e-4
# --batch_size 4 --batch_size_eval 8 --dataset cifar100 --ema_rate 0.995 --patch_size 8
# --encoder_mode unet --sample_size 5
# --mode_conditioning film --pool mean --mode_context deterministic
    ...
    logger.configure(dir=DIR, mode="training",   tag='')
