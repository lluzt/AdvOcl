...
echo "python main.py $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ENCODER_FLAGS"
...
case $RUN in
    ...
    vfsddpm_cifar100_vit_film_mean_sigma)
      run 32 3 vfsddpm cifar100 vit film mean deterministic 8 5 4 8
      ;;
    ...
    vfsddpm_cifar100_unet_film_mean_sigma)
      run 32 3 vfsddpm cifar100 unet film mean deterministic 8 5 4 8
      ;;
